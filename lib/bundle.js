...
const HerbivoreSettings = {
  ...
  maxLifeSpan: 50,           // Expected Herbivore life span. (There
...
document.addEventListener('DOMContentLoaded', () =>{
  ...
  resetButton.addEventListener("click", () => {worldMaker(view, __WEBPACK_IMPORTED_MODULE_2__config__["c" /* WorldSettings */])})
})


let worldMaker = function worldMaker(view, wSettings) {
  view.inaugurateWorld(new __WEBPACK_IMPORTED_MODULE_0__world__["a" /* default */](wSettings))
}
...
class Herbivore extends __WEBPACK_IMPORTED_MODULE_0__lifeform__["a" /* default */] {
  ...
  constructor(opts) {
    super(opts)
    this.starting_energy = __WEBPACK_IMPORTED_MODULE_1__config__["a" /* HerbivoreSettings */].startingEnergy
    this.energy = __WEBPACK_IMPORTED_MODULE_1__config__["a" /* HerbivoreSettings */].startingEnergy
...
//    this.tick()
  ...
  setupWorld() {
    ...
    for (y=0; y<__WEBPACK_IMPORTED_MODULE_1__config__["c" /* WorldSettings */].height; y++) {
      const $row = $("<ul>").addClass("world-row")
      for (x=0; x<__WEBPACK_IMPORTED_MODULE_1__config__["c" /* WorldSettings */].width; x++) {

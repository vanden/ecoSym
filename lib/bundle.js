...
/* harmony export (immutable) */ __webpack_exports__["d"] = shuffleValues;
...
const randomSample = function randomSample(obj, n) {
  let values = shuffleValues(obj)
  return values.slice(0, n)
}
/* harmony export (immutable) */ __webpack_exports__["c"] = randomSample;
...
const PlantSettings = {
  ...
  maxLifeSpan: 1000,           // Longest number of rounds a Plant can live
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__herbivore__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__plant__ = __webpack_require__(7);
...
class World {
  ...
  populateWorld() {
    let cells = Object(__WEBPACK_IMPORTED_MODULE_4__util__["d" /* shuffleValues */])(this.grid), cell
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__plant__ = __webpack_require__(7);
...
class Herbivore extends __WEBPACK_IMPORTED_MODULE_0__lifeform__["a" /* default */] {
  ...
  _findVacantNeighbours(neighbours) {
    ...
    for (let idx in neighbours) {
      ...
      } else if (neighbour.constructor.typestring === __WEBPACK_IMPORTED_MODULE_3__plant__["a" /* default */].typestring &&
                 neighbour.size === 0) {
        candidates.push(neighbour.location)
      }
    }
  ...
  _pickDirection() {
    ...
    let a = Object(__WEBPACK_IMPORTED_MODULE_2__util__["c" /* randomSample */])(candidates, 1)[0]
    return Object(__WEBPACK_IMPORTED_MODULE_2__util__["c" /* randomSample */])(candidates, 1)[0]
  }
  ...
  _spawn() {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_2__util__["a" /* chance */])() <= this.constructor.spawnChance) {
      ...
      let locs = Object(__WEBPACK_IMPORTED_MODULE_2__util__["c" /* randomSample */])(this.location.neighbourhood, numChildren)

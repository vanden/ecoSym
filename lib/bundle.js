...
Plant.growthChance = __WEBPACK_IMPORTED_MODULE_1__config__["c" /* PlantSettings */].growthChance
...
Plant.spawnChance = __WEBPACK_IMPORTED_MODULE_1__config__["c" /* PlantSettings */].spawnChance
Plant.spawnOutcomes = __WEBPACK_IMPORTED_MODULE_1__config__["c" /* PlantSettings */].spawnOutcomes
Plant.spawnOutcomes = __WEBPACK_IMPORTED_MODULE_1__config__["c" /* PlantSettings */].spawnOutcomes
Plant.spontaneousDeathChance = __WEBPACK_IMPORTED_MODULE_1__config__["c" /* PlantSettings */].spontaneousDeathChance
...
document.addEventListener('DOMContentLoaded', () =>{
  ...
  console.log(__WEBPACK_IMPORTED_MODULE_2__config__["a" /* Config */])
  myRangeSlider.value = __WEBPACK_IMPORTED_MODULE_2__config__["a" /* Config */].test
  myRangeOutput.innerHTML = myRangeSlider.value

  myRangeSlider.oninput = function() {
    __WEBPACK_IMPORTED_MODULE_2__config__["a" /* Config */].test = this.value
...
Herbivore.growthChance = __WEBPACK_IMPORTED_MODULE_1__config__["b" /* HerbivoreSettings */].growthChance
...
Herbivore.spawnChance = __WEBPACK_IMPORTED_MODULE_1__config__["b" /* HerbivoreSettings */].spawnChance
Herbivore.spawnOutcomes = __WEBPACK_IMPORTED_MODULE_1__config__["b" /* HerbivoreSettings */].spawnOutcomes
Herbivore.spontaneousDeathChance = __WEBPACK_IMPORTED_MODULE_1__config__["b" /* HerbivoreSettings */].spontaneousDeathChance
...
//    this.tick()
    ...
    let refreshID = window.setInterval(() => {this.tick()},  591)

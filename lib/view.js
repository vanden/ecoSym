...
class View {
  ...
  tick() {
    ...
    $("li[coords='23,10']").toggleClass('herbivore-1');
    $("li[coords='23,11']").toggleClass('herbivore-2');
    $("li[coords='23,12']").toggleClass('herbivore-3');
    $("li[coords='23,13']").toggleClass('herbivore-4');
    $("li[coords='23,14']").toggleClass('herbivore-5');

    $("li[coords='20,9']").toggleClass('plant-0');
    $("li[coords='20,10']").toggleClass('plant-1');
    $("li[coords='20,11']").toggleClass('plant-2');
    $("li[coords='20,12']").toggleClass('plant-3');
    $("li[coords='20,13']").toggleClass('plant-4');
    $("li[coords='20,14']").toggleClass('plant-5');

    $("li[coords='18,12']").toggleClass('rock');
